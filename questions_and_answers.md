...
Here variable name 'greating' is declared, but empty object is assigned here, so ans will be epmty object A no.
</p>
</details>
...
<i>Write your explanation here</i>
Here a value 1 is number and b value "2" is string, cannot add string to number using javascript + operator
</p>
</details>
